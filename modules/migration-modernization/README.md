...
- For API design and architecture, see [Architecture & Design](../architecture-design/)
- For cross-service integration testing, see [Testing & QA](../testing-qa/)
- For monolith-to-microservices with **platform conformance and IaC**, see [Platform-Conformant Microservice Decomposition](../cloud-infrastructure/platform-conformant-microservice-decomposition.md) (Cloud & Infrastructure category)
